...
class PagoExitosoWidget extends StatefulWidget {
  const PagoExitosoWidget({super.key});

  static String routeName = 'PagoExitoso';
  static String routePath = '/pagoExitoso';

  @override
  State<PagoExitosoWidget> createState() => _PagoExitosoWidgetState();
}
